...
public class RoundedCornerBorder extends AbstractBorder {
	...
	private static final long serialVersionUID = 6049487433540405591L;
	protected  int arch = 2; //default value
    protected Color colorLine;
    protected float withBorder = 1.2f;

    public RoundedCornerBorder() {
        colorLine = UIManager.getColor("MaterialSwing.accent1Color");
    }
